...
router.post("/enchance-prompt-with-context", prompt_controller_1.default.enhancePromptWithContext);
router.post("/enchance-prompt", prompt_controller_1.default.enhancePrompt);
